...
Replace this section with the supported versions for `gistcaster`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `gistcaster` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in .worktrees/gistcaster-e2e.
